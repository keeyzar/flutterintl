        ...
        coroutineScope {
            ...
            requests.forEach {
                if(baseLanguage == it.baseTranslation.lang) {
                    ongoingTranslationHandler.onlyGenerateBaseEntry(it) //don't add it there yet :)
            ...
            requests.forEach {
                ongoingTranslationHandler.translateAsynchronouslyWithoutPlaceholder(it, true, { false }) {
                    reportProgress(taskCounter, taskAmount)
                }
            }
        }
