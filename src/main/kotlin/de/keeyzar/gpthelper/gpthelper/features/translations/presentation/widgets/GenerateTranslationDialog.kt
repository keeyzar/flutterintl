...
class GenerateTranslationDialog(
    ...
    private lateinit var translateNowCheckBox: Cell<JBCheckBox> // Checkbox für 'Jetzt übersetzen'
    ...
    private fun fillModelData() {
        ...
        // NEU: translateNow aus History übernehmen
        model.translateNow = directLastUserInput?.translateNow ?: true
    }
    ...
    override fun createCenterPanel(): JComponent {
        _centerPanel = panel {
            group {
                ...
                row {
                    translateNowCheckBox = checkBox("Translate now?")
                        .bindSelected(model::translateNow)
                        .comment("If not, then only english with your key and description will be added to the translation file, so you can translate it later.")
                }
            }
